...
import { standingsFor, toBracketMatchView } from "@/lib/matchView";
...
export function EventDrawManager({ event, tournamentName }: { event: DrawEvent; tournamentName: string }) {
        ...
        {event.drawFormat === "SINGLE_ELIMINATION" && (
          <>
            ...
            <div className="flex flex-wrap items-center gap-3 print:hidden">
              ...
              {bracketMatches.length > 0 && <PrintDrawButton targetId={`print-draw-${event.id}`} />}
            </div>
